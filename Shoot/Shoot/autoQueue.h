#define TOSHIFT_DEADCOUNT_MIN 256
#define TOSHIFT_COUNT_MAX 128

#define DEADCOUNT_MAX 1024
...
public:
	...
	Element_t Dequeue()
	{
		...
		if(this->TopIndex == this->List->GetCount())
		{
			...
			TOSHIFT_DEADCOUNT_MIN < this->TopIndex && this->List->GetCount() - this->TopIndex < TOSHIFT_COUNT_MAX ||
			DEADCOUNT_MAX < this->TopIndex
			)
		{
